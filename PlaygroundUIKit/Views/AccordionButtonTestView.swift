...
class AccordionButtonTestView: UIView, UIGestureRecognizerDelegate {
    ...
    func viewLoad() {
        ...
        attributedString3.addAttribute(
            .paragraphStyle,
        ...
        attributedString4.addAttribute(
            .paragraphStyle,
        ...
        NSLayoutConstraint.activate([
            label1.topAnchor.constraint(equalTo: bodyView.topAnchor, constant: 5),
            label1.widthAnchor.constraint(equalTo: bodyView.widthAnchor, multiplier: 1),
            label1.centerXAnchor.constraint(equalTo: bodyView.centerXAnchor),
            label2.topAnchor.constraint(equalTo: label1.bottomAnchor),
            label2.widthAnchor.constraint(equalTo: bodyView.widthAnchor, multiplier: 1),
            label2.centerXAnchor.constraint(equalTo: bodyView.centerXAnchor),
            label3.topAnchor.constraint(equalTo: label2.bottomAnchor),
            label3.widthAnchor.constraint(equalTo: bodyView.widthAnchor, multiplier: 1),
            label3.centerXAnchor.constraint(equalTo: bodyView.centerXAnchor),
            label4.topAnchor.constraint(equalTo: label3.bottomAnchor),
            label4.widthAnchor.constraint(equalTo: bodyView.widthAnchor, multiplier: 1),
            label4.centerXAnchor.constraint(equalTo: bodyView.centerXAnchor),
            label5.topAnchor.constraint(equalTo: label4.bottomAnchor),
            label5.widthAnchor.constraint(equalTo: bodyView.widthAnchor, multiplier: 1),
            label5.centerXAnchor.constraint(equalTo: bodyView.centerXAnchor),
            label6.topAnchor.constraint(equalTo: label5.bottomAnchor),
            label6.bottomAnchor.constraint(equalTo: bodyView.bottomAnchor, constant: -5),
            label6.widthAnchor.constraint(equalTo: bodyView.widthAnchor, multiplier: 1),
            label6.centerXAnchor.constraint(equalTo: bodyView.centerXAnchor)
        ])
        ...
        guard let accordionButton = accordionButton else { return }
        ...
        NSLayoutConstraint.activate([
            headerLabel2.topAnchor.constraint(equalTo: headerView2.topAnchor, constant: 16),
            headerLabel2.bottomAnchor.constraint(equalTo: headerView2.bottomAnchor, constant: -16),
            headerLabel2.leadingAnchor.constraint(equalTo: headerView2.leadingAnchor, constant: 12),
            headerImage2.centerYAnchor.constraint(equalTo: headerView2.centerYAnchor),
            headerImage2.trailingAnchor.constraint(equalTo: headerView2.trailingAnchor, constant: -12)
        ])
        ...
        bodyLabel2.lineBreakMode = .byCharWrapping
        
        bodyView2.addSubview(bodyLabel2)
        bodyLabel2.translatesAutoresizingMaskIntoConstraints = false
        NSLayoutConstraint.activate([
            bodyLabel2.topAnchor.constraint(equalTo: bodyView2.topAnchor, constant: 16),
            bodyLabel2.bottomAnchor.constraint(equalTo: bodyView2.bottomAnchor, constant: -16),
            bodyLabel2.leadingAnchor.constraint(equalTo: bodyView2.leadingAnchor, constant: 12),
            bodyLabel2.trailingAnchor.constraint(equalTo: bodyView2.trailingAnchor, constant: -12)
        ])
        
        // アコーディオンボタン
        accordionButton2 = AccordionButton(
        ...
        guard let accordionButton2 = accordionButton2 else { return }
        ...
        NSLayoutConstraint.activate([
            ...
            accordionButton.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 50),
            accordionButton.widthAnchor.constraint(equalTo: contentView.widthAnchor, multiplier: 0.8),
            accordionButton.centerXAnchor.constraint(equalTo: contentView.centerXAnchor),
            accordionButton2Background.topAnchor.constraint(equalTo: accordionButton.bottomAnchor, constant: 50),
            accordionButton2Background.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -50),
            accordionButton2Background.widthAnchor.constraint(equalTo: contentView.widthAnchor),
            accordionButton2Background.centerXAnchor.constraint(equalTo: contentView.centerXAnchor),
            accordionButton2.topAnchor.constraint(equalTo: accordionButton2Background.topAnchor, constant: 20),
            accordionButton2.bottomAnchor.constraint(equalTo: accordionButton2Background.bottomAnchor, constant: -20),
            accordionButton2.widthAnchor.constraint(equalTo: accordionButton2Background.widthAnchor, multiplier: 0.8),
            accordionButton2.centerXAnchor.constraint(equalTo: accordionButton2Background.centerXAnchor)
        ])
